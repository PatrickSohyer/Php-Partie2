...
<html lang="fr" dir="ltr">
    ...
    <body>
        ...
        <?php
        $isOk = true; // création variable que j'initialise à true
        if ($isOk == false) { // si c'est strictement égale à false
            echo 'C\'est pas bon!!'; // si c'est True alors c'est pas bon
        } else { // sinon
            echo 'C\'est ok!!'; // c'est ok
        }
        ?>
